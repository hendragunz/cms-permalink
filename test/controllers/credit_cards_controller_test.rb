...
class CreditCardsControllerTest < ActionController::TestCase
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post :create, credit_card: { expiry_date: @credit_card.expiry_date, name: @credit_card.name, number: @credit_card.number }
    end
  ...
  test "should update credit_card" do
    patch :update, id: @credit_card, credit_card: { expiry_date: @credit_card.expiry_date, name: @credit_card.name, number: @credit_card.number }
    assert_redirected_to credit_card_path(assigns(:credit_card))
  end
